...
def set_config():
    ...
    parser.add_argument('--adjoint_step_size', type=float, default=0.5,
                        help='fixed step size when using fixed step adjoint solvers e.g. rk4')  
    parser.add_argument('--tol_scale', default = 821.9773048827274, type=float, help='multiplier for atol and rtol')
    parser.add_argument("--tol_scale_adjoint", type=float, default=1.6,
...
wandb.init(project='grand_tuning', tags='GRAND')
wandb.run.name = 'tuning_GRAND'
wandb.config = opt
main(opt, w_config)