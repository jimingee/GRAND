...
class ODEblock(nn.Module):
    ...
    def set_tol(self, w_config):
        ## rtol: Relative tolerance / atol: Absolute tolerance
        self.atol = w_config.tol_scale * 1e-7 
        self.rtol = w_config.tol_scale * 1e-9
        if self.opt['adjoint']: 
            self.atol_adjoint = w_config.tol_scale_adjoint * 1e-7
            self.rtol_adjoint = w_config.tol_scale_adjoint * 1e-9
